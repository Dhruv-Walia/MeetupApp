...
public class BlockFriendRequest extends AsyncTask<string, Void, Boolean>
{
	Context context;
	...
	public BlockFriendRequest(Activity activity,String username,String buddyname) {
	...
	protected void onPreExecute() {
    	...
    	this.dialog.setTitle("Blocking Friend Request");
        this.dialog.setMessage("Blocking...");
        this.dialog.show();
    }
	...
	protected void onPostExecute(final Boolean success) {
		 ...
		 if(success){
			 Toast.makeText(context, "Blocking successful!", Toast.LENGTH_SHORT).show();
		 }
		 else{
